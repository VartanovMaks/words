      ...
      <GameContextProvider>
        <main>
          <Router>
            ...
            <Header/>
              <Switch>
                <Route path='/select-game'><SelectGame /></Route>
                <Route path='/play'><Body /><Footer /></Route>
                <Route path='/rules'><GameRules /></Route>
                <Route path='/base'><BaseMenu/></Route>
                <Route><Redirect to='/select-game' /></Route>
              </Switch>
            </div>
          </Router>
        </main>
